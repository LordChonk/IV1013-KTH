...
public class StreamCipher {
    ...
    static BigInteger key = null; //key set to null so we can check for valid/invalid keys later
    ...
    private static void logic(String inputFile, String outputFile, BigInteger key) {
